...
export default function GoogleAdsCard({
  ...
  return (
    <ResultCard
      ...
      delay={delay}
      icon={<Search className="w-5 h-5 text-[#DA7735]" />}
      badge={
        <span
      ...
      <div className="space-y-4 pt-1">
        ...
        <div className="p-4 rounded-2xl bg-[var(--surface-subtle)] border border-[var(--border-theme)] space-y-2">
          <div className="flex items-center justify-between text-xs">
            <span className="font-bold text-[#DA7735] uppercase tracking-wider">Search Presence</span>
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            {googleAds.topKeywords.map((kw, idx) => (
              ...
              >
                <span className="text-[#DA7735] font-bold">#</span>
                {kw}
              </span>
            ))}
          </div>
        ...
        {googleAds.detectedTagIds && googleAds.detectedTagIds.length > 0 && (
          <div className="p-3 rounded-xl bg-[var(--surface-subtle)] border border-[var(--border-theme)] flex items-center gap-2 text-xs text-[var(--text-secondary)]">
            <Code className="w-4 h-4 text-[#DA7735] shrink-0" />
        ...
        {!googleAds.isRunning && (
          <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-start gap-3 text-xs text-[#E19456] leading-relaxed">
            <ShieldAlert className="w-4 h-4 text-[#E19456] shrink-0 mt-0.5" />
            <p>
