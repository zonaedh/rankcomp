  ...
  return (
    <>
      <section className="relative pt-14 pb-20 md:pt-24 md:pb-32 overflow-hidden bg-[var(--bg-base)] transition-colors duration-300">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 max-w-5xl h-[1px] bg-gradient-to-r from-transparent via-[#F0511F]/40 to-transparent pointer-events-none" />

        {/* 3. Dual Ambient Radial Glow Orbs in Coral */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[680px] h-[440px] bg-gradient-to-br from-[#F0511F]/20 via-[#781E16]/15 to-transparent rounded-full blur-3xl pointer-events-none z-0" />
        <div className="absolute top-1/4 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#F58458]/15 rounded-full blur-2xl pointer-events-none z-0" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
          ...
          >
            <span className="flex h-2 w-2 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F0511F] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F0511F]"></span>
            </span>
            <span>Free Competitor Spy Tool</span>
            <span className="text-[var(--border-accent)]">•</span>
            <span className="text-[#F0511F] font-bold">100% Free Live Check</span>
          </motion.div>
          ...
          >
            <form
              ...
              className="p-2 sm:p-2.5 rounded-2xl bg-[var(--surface-card)]/90 backdrop-blur-2xl border-2 border-[var(--border-theme)] focus-within:border-[#F0511F] shadow-xl shadow-[#F0511F]/5 transition-all"
            >
              <div className="flex flex-col sm:flex-row items-center gap-2">
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto px-7 py-3.5 sm:py-4 rounded-xl font-bold text-sm sm:text-base text-white bg-gradient-to-r from-[#781E16] to-[#F0511F] hover:from-[#410C09] hover:to-[#E23814] shadow-md shadow-[#F0511F]/25 hover:shadow-lg hover:shadow-[#F0511F]/40 transition-all flex items-center justify-center gap-2 shrink-0 cursor-pointer cta-pulse"
                >
            ...
            {error && (
              <p className="text-xs font-semibold text-rose-500 mt-2 text-left pl-3">
                {error}
              </p>
            )}
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-4 text-xs text-[var(--text-secondary)]">
              ...
              {samplePresets.map((preset) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[var(--surface)] border border-[var(--border-theme)] text-[var(--text-primary)] font-semibold hover:border-[#F0511F] hover:bg-[var(--highlight-bg)] transition-all cursor-pointer shadow-2xs"
                >
                  {preset.name}
                </button>
              ))}
              ...
              <Link
                href="/demo"
                className="font-bold text-[#F0511F] hover:text-[#F58458] flex items-center gap-1 underline underline-offset-2 transition-colors"
              >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <Globe className="w-4 h-4 text-[#F0511F]" />
