    ...
    <section id="how-it-works" className="py-16 md:py-24 relative overflow-hidden bg-[var(--bg-base)] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3 mb-16">
          <span className="text-xs font-bold uppercase tracking-widest text-[#E06859]">
            Simple & Fast
          </span>
          ...
          {steps.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[var(--surface-card)] rounded-2xl p-7 border border-[var(--border-theme)] shadow-xs relative flex flex-col justify-between hover:shadow-xl hover:shadow-black/30 hover:border-[var(--border-hover)] transition-all duration-300"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-3xl font-extrabold font-heading text-[#E06859]/20">
                      {item.step}
                    </span>
                    <div className="w-12 h-12 rounded-xl bg-[var(--highlight-bg)] text-[#E06859] flex items-center justify-center border border-[var(--highlight-border)]">
                      <Icon className="w-6 h-6 text-[#E06859]" />
                    </div>
                  </div>
                ...
                <div className="pt-5 mt-5 border-t border-[var(--border-theme)]">
                  <span className="text-[11px] font-semibold text-[#FDA4AF] bg-[var(--highlight-bg)] px-2.5 py-1 rounded-md border border-[var(--highlight-border)]">
                    {item.highlight}
                  </span>
                </div>
              </motion.div>
        ...
        <div className="mt-14 text-center">
          <Link
            href="/#search-box"
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-bold text-sm text-white bg-[#E06859] hover:bg-[#D4594A] shadow-md shadow-[#E06859]/20 transition-all"
          >
