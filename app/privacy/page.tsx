      ...
      <div className="bg-[var(--surface-card)] rounded-3xl p-6 sm:p-10 border border-[var(--border-theme)] shadow-sm space-y-8 text-sm text-[var(--text-secondary)] leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold font-heading text-[var(--text-primary)] flex items-center gap-2">
            <Lock className="w-5 h-5 text-[#DA7735]" />
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold font-heading text-[var(--text-primary)] flex items-center gap-2">
            <Database className="w-5 h-5 text-[#DA7735]" />
          ...
          <ul className="space-y-2.5 pl-2">
            ...
            <li className="flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#DA7735] mt-2 shrink-0"></span>
              <span>
                <strong className="text-[var(--text-primary)]">Lead Contact Information:</strong> When you voluntarily request a full PDF dossier or consultation booking, we collect your business email address, optional name, and phone/WhatsApp to deliver the requested services.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#DA7735] mt-2 shrink-0"></span>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold font-heading text-[var(--text-primary)] flex items-center gap-2">
            <Eye className="w-5 h-5 text-[#DA7735]" />
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold font-heading text-[var(--text-primary)] flex items-center gap-2">
            <Bell className="w-5 h-5 text-[#DA7735]" />
