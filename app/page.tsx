      ...
      <section className="py-10 sm:py-14 md:py-16 bg-[var(--bg-base)] relative overflow-hidden transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="relative rounded-2xl sm:rounded-3xl bg-[var(--surface-card)] border border-[var(--border-theme)] p-6 sm:p-8 md:p-10 text-center space-y-4 sm:space-y-5 overflow-hidden shadow-xl transition-all duration-300">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2/3 max-w-xl h-[1.5px] bg-gradient-to-r from-transparent via-[#F0511F]/50 to-transparent pointer-events-none" />

            {/* Soft Ambient Radial Glow Behind Text */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[380px] h-[220px] bg-gradient-to-br from-[#F0511F]/10 via-[#781E16]/6 to-transparent rounded-full blur-2xl pointer-events-none" />

            {/* Top Pill Badge */}
            <div className="relative z-10 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--highlight-bg)] border border-[var(--highlight-border)] text-[11px] sm:text-xs font-semibold text-[#F0511F]">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-3 pt-1">
              <Link
                href="/#search-box"
                className="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-xs sm:text-sm text-white bg-gradient-to-r from-[#781E16] to-[#F0511F] hover:from-[#410C09] hover:to-[#E23814] shadow-md shadow-[#F0511F]/20 hover:shadow-lg transition-all flex items-center justify-center gap-2 group cursor-pointer cta-pulse"
              >
